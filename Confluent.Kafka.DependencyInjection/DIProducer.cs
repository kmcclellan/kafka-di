...
sealed class DIProducer<TKey, TValue> : IProducer<TKey, TValue>
{
    readonly IServiceScope scope;
    readonly IProducer<TKey, TValue> inner;

    public DIProducer(IServiceScopeFactory factory)
    {
        this.scope = factory.CreateScope();
        this.inner = this.scope.ServiceProvider.GetRequiredService<KafkaBuilderFactory>()
            .CreateProduce<TKey, TValue>()
            .Build();
    }
